 ...
 */
HtmlWebpackPlugin.prototype.getFullTemplatePath = function(template) {
    var obj = template;
    var self = this;
    if(self.options.loader) {
      Object.keys(template).forEach(function(name) {
        obj[name] = self.options.loader + "!" + template[name];
      });
    }  
    return obj;
};
...
//          * @type {[type]}
//          */
//         template = require.resolve('html-loader') + '!' + path.resolve(context, template);
//     }
